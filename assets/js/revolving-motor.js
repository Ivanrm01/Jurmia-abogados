...
(function (raiz) {
  ...
  function evaluar(c) {
    ...
    if (!tae) {
      ...
      pasos.push({
        norma: "STS 258/2023",
        titulo: "Falta el tipo medio del año de contratación",
        cumple: false,
        detalle: "La TAE pactada fue del " + tae + " %. Debe tomarse el tipo medio publicado por el Banco de España para " +
          anio + " en el capítulo 19.4 de su Boletín Estadístico y compararlo con el pactado. El umbral son seis puntos porcentuales."
      });
    } else {
      usura = tae > umbral;
      pasos.push({
    ...
    var viable = Boolean(usura) || transparencia;
    var veredicto = usura ? "usura" : (transparencia ? "transparencia" : "a_estudiar");
